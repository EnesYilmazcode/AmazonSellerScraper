 ...
 *
 * CLOUD_SYNC is off in 2.1. Scrapes are not queued for the cloud, the
 ...
 *
 * Loaded as a plain global (`Flags`) in the popup and content scripts, and
 * as a CommonJS module in Jest and the bundled service worker.
 */
