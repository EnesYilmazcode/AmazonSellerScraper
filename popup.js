...
function updateLiveData(results) {
    ...
    results.forEach(item => {
        ...
        row.innerHTML = `
            ...
            <td style="border: 1px solid #ccc; padding: 5px;">${item.asin || 'N/A'}</td>
            <td style="border: 1px solid #ccc; padding: 5px;">${item.price || 'N/A'}</td>
            <td style="border: 1px solid #ccc; padding: 5px;">${item.rating || 'N/A'}</td>
            <td style="border: 1px solid #ccc; padding: 5px;">${item.reviewCount || 'N/A'}</td>
        `;
