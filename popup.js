...
// Listen for product count from the content script
chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
    ...
    } else if (request.type === 'SELLER_PRODUCT_COUNT') {
        document.getElementById('productCount').innerText = `Total products: ${request.count}`;
    }
});
